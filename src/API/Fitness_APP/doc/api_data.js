define({ "api": [
  ...
  {
    "type": "post",
    "url": "/sports/fitness/createFitnessPlan/",
  ...
  {
    "type": "delete",
    "url": "/sports/fitness/deleteFitnessPlan/",
    "title": "Delete fitness plan (Used by test)",
    "version": "1.0.0",
    "name": "deleteFitnessPlan",
    "group": "Fitness",
    "parameter": {
      "fields": {
        "Param": [
          {
            ...
            "optional": false,
            "field": "fitnessPlanId",
            "description": "<p>Id of fitness plan to delete</p>"
          }
        ]
      }
    },
        ...
        "Success 200": [
          {
            ...
            "optional": false,
            "field": "message",
            "description": "<p>Fitness plan successfully deleted.</p>"
          }
        ]
      }
    },
        ...
        "Param": [
          {
            ...
            "optional": false,
            "field": "fitnessPlanId",
            "description": "<p>Id of fitness plan to receive data from</p>"
          }
        ]
      }
    },
  ...
  {
    "type": "delete",
    "url": "/sports/running/deleteRun/",
    "title": "Delete run (Used by test)",
    "version": "1.0.0",
    "name": "deleteRun",
    "group": "Running",
    "parameter": {
        ...
        "Param": [
          {
            ...
            "optional": false,
            "field": "runId",
            "description": "<p>Id of run to delete</p>"
          }
        ]
      }
    },
        ...
        "Success 200": [
          {
            ...
            "optional": false,
            "field": "message",
            "description": "<p>Run successfully deleted.</p>"
          }
        ]
      }
    },
